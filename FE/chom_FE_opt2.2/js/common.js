...
function ScrollEffects() {
  ...
  if ($(window).width() < 1025) {
    ...
    $(
      "nav, #canvas-slider, #showcase-slider-holder, #showcase-carousel-holder, #hero.has-image #hero-styles, #hero.has-slider, #hero.has-slider #hero-styles, #hero-image-wrapper, .thumb-container, .thumb-page"
    ...
    finished: function () {
      if ($(window).width() > 479) {
        $(".pinned-element").each(function () {
          var $this = $(this);
          var $totalHeight =
            $this.siblings(".scrolling-element").height() -
  ...
  if ($("body").hasClass("hero-below-caption")) {
    $("#hero-footer").each(function () {
      var $this = $(this);
      var $totalHeight =
        $("#hero.has-image").outerHeight(true) - window.innerHeight;
      gsap.to(".pinned-element", {
        scrollTrigger: {
...
function FirstLoad() {
  ...
  if ($("#page-content").hasClass("light-content")) {
    ...
    $("main, #main-content.solid-color, #page-nav").css(
      "background-color",
      function () {
  ...
  $("a.ajax-link").on("click", function () {
    ...
    gsap.to(
      $(
        "#main, #hero-image-wrapper, #project-nav, .next-project-image, #app, #canvas-slider, #showcase-slider-webgl-holder, #quickmenu-scroll, #blog, .next-project-image-wrapper"
      ),
  ...
  if (!$("body").hasClass("load-no-ajax")) {
    if ($("#itemsWrapper").hasClass("webgl-fitthumbs")) {
      ...
      $(
        ...
        gsap.to(
          "#hero, #show-filters, .item-caption-wrapper, #page-nav, footer, .showcase-list-header",
    ...
    if ($("#itemsWrapper").hasClass("scale-fitthumbs")) {
      ...
      function addListeners(tile, page, url) {
        url.addEventListener("click", function () {
          ...
          gsap.to(
            "#hero, #show-filters, .item, .item-caption-wrapper, #page-nav, footer, .showcase-list-header",
