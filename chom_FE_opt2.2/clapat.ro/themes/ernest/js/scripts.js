    ...
    $("body").waitForImages({
      finished: function () {
        ...
        setTimeout(function () {
          ...
          gsap.to($(".swiper-pagination-bullet .title div"), {
            duration: 1,
            y: 0,
            opacity: 1,
            delay: 0.6,
          ...
          gsap.to($(".swiper-pagination-bullet-active .subtitle span"), {
            duration: 0.7,
            y: 0,
            opacity: 1,
            delay: 1,
          ...
          gsap.to(
            $(
              "#showcase-carousel-holder .swiper-slide-active .slide-title span"
            ),
            {
              duration: 0.7,
              force3D: true,
          ...
          gsap.to(
            $("#showcase-carousel-holder .swiper-slide-active .subtitle span"),
            {
              duration: 0.7,
              force3D: true,
              y: 0,
          ...
          gsap.to(
            $(
              "#showcase-carousel-holder .swiper-slide-active .slide-date span"
            ),
            {
              duration: 0.7,
              force3D: true,
          ...
          gsap.to($(".swiper-pagination-bullet"), {
            duration: 0.7,
            force3D: true,
            y: 0,
            opacity: 1,
...
function SliceTitles() {
  $(
    "#main .has-image .hero-title, #main #project-nav .next-hero-title, #main #project-nav .next-temp-hero-title"
  ).each(function () {
  ...
  $(
    "#main .has-image .hero-title div, #main #project-nav .next-hero-title div, #main #project-nav .next-temp-hero-title div"
  ).each(function () {
...
function PageLoadActions() {
  ...
  TempNextTitle.to($(".next-caption").find(".next-temp-hero-title span"), {
    duration: 0.5,
    y: -10,
    rotationX: 78,
    transformOrigin: "50% 10% 0px",
    opacity: 0,
    stagger: 0.02,
    ease: Power2.easeInOut,
  });
  NextTitle.to($(".next-caption").find(".next-hero-title span"), {
    duration: 0.5,
    y: 0,
    rotationX: 0,
    transformOrigin: "50% 10% 0px",
  ...
  if (!$("body").hasClass("load-no-ajax")) {
    $(".next-ajax-link-project").on("click", function () {
      gsap.set($(".next-caption").find(".next-temp-hero-title span"), {
        y: 10,
        rotationX: -78,
        transformOrigin: "50% 90% 0px",
        opacity: 0,
      });
      gsap.set($(".next-caption").find(".next-hero-title span"), {
        y: 0,
        rotationX: 0,
        transformOrigin: "50% 10% 0px",
        opacity: 1,
...
function LazyLoad() {
  ...
  gsap.to($("#showcase-carousel-holder .swiper-slide .slide-title span"), {
    duration: 0.3,
    force3D: true,
    y: 0,
    opacity: 1,
  ...
  gsap.to($("#showcase-carousel-holder .swiper-slide .subtitle span"), {
    duration: 0.3,
    force3D: true,
    y: 0,
    opacity: 1,
  ...
  if ($("#showcase-slider-holder").length > 0) {
          ...
          $(".showcase-pagination")
            ...
            .each(function () {
              if (!$(this).hasClass("swiper-pagination-bullet-active")) {
                ...
                gsap.set($(this).find(".title span"), {
                  y: -10,
                  rotationX: 78,
                  transformOrigin: "50% 90% 0px",
                  opacity: 0,
                });
                gsap.set($(this).find(".subtitle span"), {
                  y: -30,
                  opacity: 0,
                });
                gsap.to($(this).find(".title span"), {
    ...
    if (!$("body").hasClass("load-no-ajax")) {
      $("#showcase-slider-holder .slide-title").on("click", function () {
        ...
        gsap.to(
          "footer, #hero-footer, .showcase-pagination-wrap .parallax-element, .caption-border",
...
function ShowcaseCarousel() {
  if ($("#showcase-carousel-holder").length > 0) {
          ...
          $("#showcase-carousel")
            ...
            .each(function () {
              if (!$(this).hasClass("swiper-slide-active")) {
                gsap.to($(this).find(".slide-date span"), {
                  duration: 0.5,
                  y: 30,
                  opacity: 0,
                  ease: Power2.easeInOut,
                });
                gsap.to($(this).find(".slide-title span"), 0.5, {
                  y: 120,
                  opacity: 0,
                  ease: Power2.easeInOut,
                });
                gsap.to($(this).find(".subtitle span"), 0.5, {
                  y: 30,
                  opacity: 0,
                  ease: Power2.easeInOut,
                });
              } else {
                gsap.set($(this).find(".slide-date span"), {
                  y: -30,
                  opacity: 0,
                });
    ...
    if ($(window).width() >= 1024) {
      $("#showcase-carousel-holder .slide-title").on(
        "mousedown",
        function (event) {
          return false;
        }
    ...
    if (!isMobile()) {
      $(".item-wrap-image").mouseenter(function (e) {
        ...
        if ($("#page-content").hasClass("light-content")) {
          ...
          $("#ball")
            .addClass("with-icon")
            .append('<i class="arrow-icon white"></i>');
        } else {
          gsap.to("#ball", {
            duration: 0.3,
            borderWidth: "2px",
